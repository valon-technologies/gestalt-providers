...
var workflowHostConnector = func() (workflowHost, error) {
...
func (p *Provider) Configure(ctx context.Context, name string, raw map[string]any) error {
	...
	host, err := workflowHostConnector()
	if err != nil {
		_ = db.Close()
...
func normalizeTarget(target *gestalt.BoundWorkflowTarget) (scopedTarget, error) {
	...
	if target.Plugin != nil && target.Agent != nil {
		return scopedTarget{}, errors.New("target must set exactly one of plugin or agent")
	}
	if target.Agent != nil {
		agent := *target.Agent
...
func workflowRunStatusString(status gestalt.WorkflowRunStatus) string {
	switch status {
	case gestalt.WorkflowRunStatusValueUnspecified:
		return "unspecified"
...
func signalInputs(records []workflowSignalRecord) []gestalt.WorkflowSignal {
	...
	for _, record := range records {
		if input := record.signalProto(); input != nil {
...
func cloneSignal(signal *gestalt.WorkflowSignal) *gestalt.WorkflowSignal {
	...
	cloned, err := cloneJSONPtr(signal)
	if err != nil {
...
func workflowTargetProto(target *gestalt.BoundWorkflowTarget) (*gestalt.BoundWorkflowTarget, error) {
	return cloneJSONPtr(target)
}

func workflowOutputDeliveryProto(delivery *gestalt.WorkflowOutputDelivery) (*gestalt.WorkflowOutputDelivery, error) {
	return cloneJSONPtr(delivery)
}

func workflowEventProto(event *gestalt.WorkflowEvent) (*gestalt.WorkflowEvent, error) {
	return cloneJSONPtr(event)
}

func workflowSignalProto(signal *gestalt.WorkflowSignal) (*gestalt.WorkflowSignal, error) {
	return cloneJSONPtr(signal)
}

func workflowScheduleProto(schedule *gestalt.BoundWorkflowSchedule) (*gestalt.BoundWorkflowSchedule, error) {
	return cloneJSONPtr(schedule)
}

func workflowEventTriggerProto(trigger *gestalt.BoundWorkflowEventTrigger) (*gestalt.BoundWorkflowEventTrigger, error) {
	return cloneJSONPtr(trigger)
}

func workflowRunProto(run *gestalt.BoundWorkflowRun) (*gestalt.BoundWorkflowRun, error) {
	return cloneJSONPtr(run)
}

func workflowExecutionReferenceProto(ref *gestalt.WorkflowExecutionReference) (*gestalt.WorkflowExecutionReference, error) {
	return cloneJSONPtr(ref)
}

func workflowEventInput(event *gestalt.WorkflowEvent) *gestalt.WorkflowEvent {
	return cloneEvent(event)
}

func cloneJSONPtr[T any](value *T) (*T, error) {
	if value == nil {
		return nil, nil
	}
...
func cloneMap(value map[string]any) map[string]any {
	...
	cloned, ok := cloneAny(value).(map[string]any)
	if !ok {
		return nil
	}
	return cloned
...
func timePtrFromPtr(value *time.Time) *time.Time {
	if value == nil {
		return nil
	}
...
func (r workflowScheduleRecord) toProto() (*gestalt.BoundWorkflowSchedule, error) {
	return workflowScheduleProto(&gestalt.BoundWorkflowSchedule{
		ID:           r.ID,
		Cron:         r.Cron,
		Timezone:     r.Timezone,
...
func (r workflowEventTriggerRecord) toProto() (*gestalt.BoundWorkflowEventTrigger, error) {
	return workflowEventTriggerProto(&gestalt.BoundWorkflowEventTrigger{
		ID: r.ID,
...
func (r workflowRunRecord) toProto() (*gestalt.BoundWorkflowRun, error) {
	return workflowRunProto(&gestalt.BoundWorkflowRun{
		ID:            r.ID,
...
func (r workflowRunRecord) triggerInput() *gestalt.WorkflowRunTrigger {
	...
	case triggerKindEvent:
		return &gestalt.WorkflowRunTrigger{Event: &gestalt.WorkflowEventTriggerInvocation{
			...
			Event:     workflowEventInput(r.TriggerEvent),
		}}
	default:
...
func executionReferenceRecordFromProto(ref *gestalt.WorkflowExecutionReference) (workflowExecutionReferenceRecord, error) {
	if ref == nil {
...
func cloneExecutionReference(ref *gestalt.WorkflowExecutionReference) *gestalt.WorkflowExecutionReference {
	...
	if err != nil {
		return &gestalt.WorkflowExecutionReference{
			...
			Permissions:         workflowPermissionInputs(ref.Permissions),
			CreatedAt:           ref.CreatedAt,
			RevokedAt:           timePtrFromPtr(ref.RevokedAt),
...
func cloneTarget(target *gestalt.BoundWorkflowTarget) *gestalt.BoundWorkflowTarget {
	...
	cloned, err := cloneJSONPtr(target)
	if err != nil {
		return target
	}
	return cloned
