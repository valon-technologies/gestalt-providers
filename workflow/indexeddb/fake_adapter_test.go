...
func (s workflowObjectStoreAdapter) OpenKeyCursor(ctx context.Context, r *gestalt.KeyRange, dir gestalt.CursorDirection) (workflowCursor, error) {
	cur, err := s.ProviderStore.OpenKeyCursor(ctx, r, dir)
	if err != nil {
		return nil, err
	}
	return workflowCursorAdapter{ProviderCursor: cur}, nil
...
func (idx workflowIndexAdapter) OpenKeyCursor(ctx context.Context, r *gestalt.KeyRange, dir gestalt.CursorDirection, values ...any) (workflowCursor, error) {
	cur, err := idx.ProviderIndex.OpenKeyCursor(ctx, r, dir, values...)
	if err != nil {
		return nil, err
	}
	return workflowCursorAdapter{ProviderCursor: cur}, nil
