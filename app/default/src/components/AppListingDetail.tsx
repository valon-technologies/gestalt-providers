...
export default function AppListingDetail({
  ...
  return (
    <dialog
      ...
      className="fixed inset-0 z-50 m-auto w-[min(100%-2rem,28rem)] max-h-[min(100%-2rem,36rem)] overflow-y-auto rounded-xl border border-alpha bg-base-white p-0 text-foreground shadow-lg backdrop:bg-base-950/40 dark:bg-surface"
