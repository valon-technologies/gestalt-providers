 ...
 * Typing filters the grid in AppsCatalogPageClient.
 */
    ...
    <div className="w-full max-w-sm">
      <div className="relative">
        ...
        {trimmedQuery.length > 0 && !disabled && (
          <button
            type="button"
            className="absolute right-2 top-1/2 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-md text-faint transition-colors duration-150 hover:bg-alpha-5 hover:text-muted-foreground"
