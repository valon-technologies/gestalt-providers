...
/**
 * MCP client logomarks for Setup (24 viewBox).
...
/** Anthropic clay. Official primary accent for Claude and Claude Code. */
const ANTHROPIC_CLAY = "#D97757";

export function ClaudeIcon({ className }: { className?: string }) {
  // Claude app mark — Anthropic starburst (simple-icons `claude`) in clay.
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function ClaudeCodeIcon({ className }: { className?: string }) {
  // Claude Code pixel mark (simple-icons `claudecode`) in the same clay as
  // Claude. Anthropic brand orange #D97757.
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function ChatGptIcon({ className }: { className?: string }) {
  // Official ChatGPT / Codex Desktop app icon (unified 2026 desktop app).
  // Blob + `>_`, lavender → blue. Source: @lobehub/icons-static-svg `codex-color`.
  const gradientId = `chatgpt-app-${useId().replace(/:/g, "")}`;
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function CodexIcon({ className }: { className?: string }) {
  // Same official mark as ChatGPT (unified 2026 desktop app).
