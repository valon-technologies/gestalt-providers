...
const APP_PROMPT_BODIES: Readonly<Record<string, readonly string[]>> = {
  ...
  exampleOnCall: ["Who’s on call right now?"],
  ...
  exampleQuiz: ["Am I ready for another knowledge check?"],
  exampleOnboarding: ["What’s next in my onboarding?"],
  intercom: ["What support threads need me today?"],
  exampleInbox: ["What threads need a human today?"],
