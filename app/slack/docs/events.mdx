...
HMAC signatures against configured `signingSecrets` or
`slackApps.<ref>.signingSecret`, and by default resolve the Slack team/user
through the managed `external_identity` authorization relationship. Matching
