...
The repository requires a `PAT_TOKEN` Actions secret with read access to `valon-technologies/gestalt` so compiled plugins can fetch the private Go SDK module.
