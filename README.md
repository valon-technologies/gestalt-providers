...
externalcredentials/<name>/ External credential providers (Go)
s3/<name>/            S3-compatible object-store providers (Go)
indexeddb/<name>/     IndexedDB providers (Go, Rust)
...
```sh
git tag app/slack/v0.0.1-alpha.1
git push origin app/slack/v0.0.1-alpha.1
```
