...
@plugin.operation(id="connection.test", method="POST", description='Open an SFTP session to the configured UGI endpoint.')
...
@plugin.operation(id="remote.listFiles", method="POST", description='List files in any remote UGI directory.', read_only=True)
...
@plugin.operation(id="remote.downloadFile", method="POST", description='Download a file from any remote UGI path.', read_only=True)
...
@plugin.operation(id="remote.uploadFile", method="POST", description='Upload a file to any remote UGI path.')
...
@plugin.operation(id="remote.moveFile", method="POST", description='Move or rename a file on the remote UGI endpoint.')
...
@plugin.operation(id="remote.deleteFile", method="POST", description='Delete a file from the remote UGI endpoint.')
