...
LIST_OPS = [('received.listFiles', 'List files published by NGLS in the configured received_dir.', 'received_dir')]
DOWNLOAD_OPS = [('received.downloadFile', 'Download a file from the configured received_dir.', 'received_dir')]
UPLOAD_OPS = [('inbound.uploadFile', 'Upload a file to the configured inbound_dir used for outbound submissions to NGLS.', 'inbound_dir'), ('documents.uploadFile', 'Upload a file to the configured insurance_documents_dir.', 'insurance_documents_dir'), ('noticeResponses.uploadFile', 'Upload a notice-response file to the configured notice_response_dir.', 'notice_response_dir')]
DELETE_OPS = [('received.deleteFile', 'Delete a processed file from the configured received_dir.', 'received_dir')]
...
@plugin.operation(id="connection.test", method="POST", description='Open an SFTP session to the configured NGLS endpoint.')
...
@plugin.operation(id="remote.listFiles", method="POST", description='List files in any remote NGLS directory.', read_only=True)
...
@plugin.operation(id="remote.downloadFile", method="POST", description='Download a file from any remote NGLS path.', read_only=True)
...
@plugin.operation(id="remote.uploadFile", method="POST", description='Upload a file to any remote NGLS path.')
...
@plugin.operation(id="remote.moveFile", method="POST", description='Move or rename a file on the remote NGLS endpoint.')
...
@plugin.operation(id="remote.deleteFile", method="POST", description='Delete a file from the remote NGLS endpoint.')
