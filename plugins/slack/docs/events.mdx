...
Slack-visible acknowledgement reactions and native assistant loading status
updates are best effort and run before thread-context prefetch and workflow
handoff. Failures there are reported in the response body but do not block the
