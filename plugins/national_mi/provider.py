...
LIST_OPS = [('servicingTransfers.listFiles', 'List servicing transfer files in the configured servicing_transfer_dir.', 'servicing_transfer_dir'), ('billing.listFiles', 'List billing files in the configured billing_dir.', 'billing_dir'), ('postTransferReports.listFiles', 'List post-transfer reports in the configured post_transfer_report_dir.', 'post_transfer_report_dir')]
DOWNLOAD_OPS = [('billing.downloadFile', 'Download a billing file from the configured billing_dir.', 'billing_dir'), ('postTransferReports.downloadFile', 'Download a post-transfer report from the configured post_transfer_report_dir.', 'post_transfer_report_dir')]
UPLOAD_OPS = [('servicingTransfers.uploadFile', 'Upload a servicing transfer or MISMO file to the configured servicing_transfer_dir.', 'servicing_transfer_dir'), ('remittance.uploadFile', 'Upload a remittance or response file to the configured remittance_dir.', 'remittance_dir')]
DELETE_OPS = []
...
@plugin.operation(id="connection.test", method="POST", description='Open an SFTP session to the configured National MI endpoint.')
...
@plugin.operation(id="remote.listFiles", method="POST", description='List files in any remote National MI directory.', read_only=True)
...
@plugin.operation(id="remote.downloadFile", method="POST", description='Download a file from any remote National MI path.', read_only=True)
...
@plugin.operation(id="remote.uploadFile", method="POST", description='Upload a file to any remote National MI path.')
...
@plugin.operation(id="remote.moveFile", method="POST", description='Move or rename a file on the remote National MI endpoint.')
...
@plugin.operation(id="remote.deleteFile", method="POST", description='Delete a file from the remote National MI endpoint.')
