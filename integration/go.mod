module github.com/valon-technologies/gestalt-providers/integration

go 1.26

require (
	github.com/valon-technologies/gestalt-providers/external_credentials/default v0.0.0-00010101000000-000000000000
...
// Local replace targets so the integration tests run against the source
// snapshots of these providers in this repo (instead of pinned releases).
// The integration target is build-time-only — it has no install path and is
// not packaged or released.
replace github.com/valon-technologies/gestalt-providers/external_credentials/default => ../external_credentials/default
